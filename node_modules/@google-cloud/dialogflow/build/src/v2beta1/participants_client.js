...
class ParticipantsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.stream = {
            streamingAnalyzeContent: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.BIDI_STREAMING, !!opts.fallback, 
    ...
    updateParticipant(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'participant.name': (_a = request.participant.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    analyzeContent(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                participant: (_a = request.participant) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
